...
class AuthControllerTest {
    ...
    void shouldRegisterUserGivenValidUserDetails() {
        given().contentType(ContentType.JSON)
                ...
                .body("photoUrl", equalTo("/api/v1/users/photo/default.png"));
    }
    ...
    void shouldReturnHTTP400IfUserDetailsAreInvalid(){
        given().contentType(ContentType.JSON)
                ...
                .body("errors.name.getFirst()", equalTo("Name is required"))
                .body("errors.email.getFirst()", equalTo("Email should be valid"));
    }
    ...
    void shouldLoginUserAndReturnJwtTokenIfCredentialsAreCorrect() {
        given().contentType(ContentType.JSON)
                ...
                .body("email", equalTo("jdoe@gmail.com"));
    }
    ...
    private String  authenticateRequest() {
        return given().contentType(ContentType.JSON)
                ...
                .extract()
                .body()
                .as(GlobalDTO.LoginResponse.class).token();
    }
    ...
    void shouldSendResetTokenGivenAValidUserEmail() {
        given().contentType(ContentType.JSON)
                ...
                .body("message", equalTo("A password reset link has been sent to jdoe@gmail.com"));
    }
